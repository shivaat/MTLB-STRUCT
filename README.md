...
Note that the evaluation performance results that you see after running `load_test.py`, are based on seqeval NER metrics and not the PARSEME evaluation measures. 
